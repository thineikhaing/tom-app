...
public interface LeaveRepository extends JpaRepository<Leave, String> {
    ...
    @Query(value = "SELECT * FROM leave WHERE employee_id  = :employeeId AND leave_type  = :leaveType AND " +
            "start_date  = :startDate AND end_date  = :endDate ", nativeQuery = true)
    List<Leave> findByEmployeeIdAndLeaveTypeAndStartDateAndEndDate
            (@Param("employeeId") String employeeId, @Param("leaveType") String leaveType,
